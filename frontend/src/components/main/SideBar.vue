  ...
  <div class="flex w-12 flex-col items-center h-full gap-6 justify-between">
    ...
    <div class="space-y-4 flex flex-col text-center w-full items-center flex-1">
      ...
      <router-link
        ...
        <span
          :class="
            activeLink === 'task' ? 'icon-[ic--round-download]' : 'icon-[ic--outline-download]'
          "
          class="size-[1.75rem]"></span>
      </router-link>
      <router-link
        ...
        <span
          :class="
            activeLink === 'setting' ? 'icon-[ic--round-settings]' : 'icon-[ic--outline-settings]'
          "
          class="size-6"></span>
      </router-link>
      <router-link
        ...
        <span
          :class="
            activeLink === 'plugins' ? 'icon-[ic--round-extension]' : 'icon-[ic--outline-extension]'
          "
          class="size-6"></span>
      </router-link>
    </div>
    ...
    <div class="flex mt-auto flex-col space-y-2 pb-4">
      <router-link class=" " :to="{ name: 'info' }" @click="setActiveLink('about')">
        <span
          :class="activeLink === 'about' ? 'icon-[ic--round-info]' : 'icon-[lucide--info]'"
          class="size-5"></span>
      </router-link>
